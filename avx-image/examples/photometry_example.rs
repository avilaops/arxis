...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("   Average color: RGB({:.3}, {:.3}, {:.3})",
             analysis.average_color.0,
             analysis.average_color.1,
             analysis.average_color.2);
    ...
    println!("   RGB multipliers: ({:.3}, {:.3}, {:.3})",
             illuminant.rgb_multipliers.0,
             illuminant.rgb_multipliers.1,
             illuminant.rgb_multipliers.2);
    ...
    println!("   Most frequent bin: {} (value: {:.4})", max_bin.0, max_bin.1);
