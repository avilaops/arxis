...
export const activityModules: ModuleDefinition[] = [
  ...
  {
    id: 'stakeholders',
    label: 'Stakeholders Portal',
    path: '/stakeholders',
    icon: 'People',
    description: 'Experiência dedicada para clientes, conselho e fornecedores com dados segmentados.',
    pages: [
      {
        name: 'Visão Executiva',
        description: 'Dashboards financeiros, marcos e status de riscos para o conselho.',
      },
      {
        name: 'Portal Colaborativo',
        description: 'RFIs, contratos, checklists e comunicação bidirecional com clientes.',
      },
      {
        name: 'Experiência de Fornecedores',
        description: 'Pedidos, entregas, documentação e fluxo de aprovações integrados.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    path: '/crm',
    icon: 'TrendingUp',
    description: 'Gestão completa de vendas com leads, oportunidades, atividades e cadências.',
    pages: [
      { name: 'Sales Dashboard', description: 'Visão geral de vendas com inbox prioritário e métricas.' },
      { name: 'Leads', description: 'Gestão de leads com scoring, temperatura e conversão.' },
      { name: 'Contacts', description: 'Base de contatos qualificados e informações comerciais.' },
      { name: 'Opportunities', description: 'Pipeline de oportunidades com próximos passos obrigatórios.' },
      { name: 'Activities', description: 'Rastreamento de todas as atividades de vendas.' },
      { name: 'Cadences', description: 'Sequências automatizadas de follow-up.' },
      { name: 'Templates', description: 'Templates de email, propostas e materiais de vendas.' },
      { name: 'Scripts', description: 'Scripts de vendas com perguntas e objeções.' },
    ],
  },
  {
    id: 'settings',
  ...
  },
  {
    ...
    pages: [
      { name: 'Gestão de Usuários', description: 'Administração completa de usuários do sistema.' },
  ...
  },
  {
    ...
    path: '/viewer',
    icon: 'Model3D',
    description: 'Visualização e navegação de modelos BIM (IFC/GLTF).',
    pages: [
      { name: '3D Viewer', description: 'Upload e navegação de arquivos IFC/GLTF.' }
    ]
  },
]
