...
fn main() {
    ...
    println!("🌌 GEOMETRIA:");
    println!(
        "   • Galáxia lente: z_L = {:.3} → d_L = {:.0} Mpc",
        z_lens,
        d_lens / 3.086e22
    );
    println!(
        "   • Quasar fonte: z_S = {:.3} → d_S = {:.0} Mpc",
        z_source,
        d_source / 3.086e22
    );
    ...
    println!(
        "   • Tempo até coalescência: {:.2e} anos",
